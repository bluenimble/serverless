...
public class IntegerValueConverter implements OptionArgumentValueConverter {
	...
	public Object cast (String optionName, String value) throws ArgumentValueCastException {
		...
		try {
			...
			throw new ArgumentValueCastException ("Option [" + optionName + "], Argument [" + value + "] must be a valid number");
		}
	}
