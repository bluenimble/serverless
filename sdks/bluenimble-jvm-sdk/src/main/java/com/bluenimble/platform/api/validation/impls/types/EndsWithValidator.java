...
public class EndsWithValidator extends AbstractTypeValidator {

	private static final long serialVersionUID = 2430274897113013353L;
	
	public static final String Type 				= "EndsWith";
	
	public static final String TypeMessage			= "EndsWith";
	...
	public Object validate (Api api, ApiConsumer consumer, ApiRequest request, 
		...
		if (!String.valueOf (value).endsWith (token)) {
			String msg = null; 
