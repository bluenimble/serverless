...
public interface PrinterEntities {
	...
	public final static String AUML = "&#196;"; // capital A, dieresis or umlaut

	// mark

	public final static String ARING = "&#197;"; // capital A, ring

	public final static String AELIG = "&#198;"; // capital AE diphthong
	...
	public final static String EMUL = "&#203;"; // captial E, dieresis ur umlaut
	...
	public final static String IUML = "&#207;"; // capital I, dieresis or umlaut
	...
	public final static String OUML = "&#214;"; // capital O, dieresis or umlaut
	...
	public final static String UUML = "&#220;"; // capital U, dieresis or umlaut
	...
	public final static String SZLIG = "&#223;"; // small sharp s, German (sz
	...
	public final static String aUML = "&#228;"; // small a, dieresis or umlaut

	// mark

	public final static String aRING = "&#229;"; // small a, ring

	public final static String aELIG = "&#230;"; // small ae diphthong
	...
	public final static String eUML = "&#235;"; // small e, dieresis or umalut
	...
	public final static String iUML = "&#239;"; // small i, dieresis or umalut
	...
	public final static String oUML = "&#246;"; // small o, diersis or umalut
	...
	public final static String uUML = "&#252;"; // small u, dieresis or umalut
	...
	public final static String yUML = "&#255;"; // small y, dieresis or umlaut
	...
	public final static String EPSILON = "&#917;"; // greek capital letter
	...
	public final static String OMICRON = "&#927;"; // greek capital letter
	...
	public final static String UPSILON = "&#933;"; // greek capital letter
	...
	public final static String thetasym = "&#977;"; // greek small letter
	...
	public final static String IMAGE = "&#8465;"; // blackletter capital I

	// (imaginary part)

	public final static String REAL = "&#8476;"; // blackletter capital R (real
	...
	public final static String CRARR = "&#8529;"; // downwards arrow with corner
	...
	public final static String SCARON = "&#339;"; // latin capital letter S with

	// caron

	public final static String sCARON = "&#353;"; // latin small letter s with

	// caron

	public final static String YUML = "&#376;"; // latin capital letter Y with

	// diaeresis

	// Spcaing Modifier letters
	public final static String CIRC = "&#710;"; // modifier letter circumflex
	...
	public final static String LSAQUO = "&#8249;"; // single left-pointing angle

	// mark

	public final static String RSQQUO = "&#8250;"; // single right-pointing
	// angle mark
}