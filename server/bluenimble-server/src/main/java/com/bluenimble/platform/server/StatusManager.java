...
public interface StatusManager extends Serializable {
	...
	ApiStatus 	get 	(Api api);
	ApiStatus 	get 	(Api api, ApiService service);
	
	void 		update 	(Api api, ApiStatus status);
	void 		update 	(Api api, ApiService service, ApiStatus status);
