...
public abstract class AbstractDescribeSpaceSpi extends AbstractApiServiceSpi {

	private static final long serialVersionUID = -3682312790255625219L;

	public ApiOutput describe (Api api, ApiRequest request, ApiSpace space) throws ApiServiceExecutionException {
		return new JsonApiOutput (
			space.describe (MgmUtils.options ((String)request.get (CommonSpec.Options), DescribeOption.Info))
		);
	}
