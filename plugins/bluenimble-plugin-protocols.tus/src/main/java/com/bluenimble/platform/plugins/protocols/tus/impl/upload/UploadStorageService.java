...
public interface UploadStorageService {
    ...
    StorageObject getData (UploadInfo info, String ownerKey) throws IOException;
     ...
     */
    UploadInfo getUploadInfo (UUID id, String ownerKey) throws IOException;
     ...
     */
    UploadInfo append(UploadInfo upload, String ownerKey, InputStream inputStream) throws IOException, TusException;
     ...
     */
    void update(UploadInfo uploadInfo, String ownerKey) throws IOException, UploadNotFoundException;
     ...
     */
    InputStream getUploadedBytes (UploadInfo uploadInfo, String ownerKey) throws IOException, UploadNotFoundException;
     ...
     */
    void copyUploadTo(UploadInfo info, String ownerKey, OutputStream outputStream) throws UploadNotFoundException, IOException;
     ...
     */
    void removeLastNumberOfBytes(UploadInfo uploadInfo, String ownerKey, long byteCount) throws UploadNotFoundException, IOException;
     ...
     */
    void terminateUpload(UploadInfo uploadInfo, String ownerKey) throws UploadNotFoundException, IOException;
    ...
    void 			setMetaSerializer (MetaSerializer serializer);
    MetaSerializer 	getMetaSerializer ();
