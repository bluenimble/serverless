...
* Download either [bluenimble-1.4.0-bin.zip](https://github.com/bluenimble/serverless/releases/download/v1.4.0/bluenimble-1.4.0-bin.zip) or [bluenimble-1.4.0-bin.tar.gz](https://github.com/bluenimble/serverless/releases/download/v1.4.0/bluenimble-1.4.0-bin.tar.gz) and decompress in a folder of your choice
* If you're a Mac or Linux user, set the right .sh file mode:
    ````
    cd ~/bluenimble-1.4.0 && sudo chmod 755 *.sh
    ````
#### Start BlueNimble 
* Mac or Linux users
    ````
...
* Download either [bluenimble-cli-1.4.0-bin.zip](https://github.com/bluenimble/serverless/releases/download/v1.4.0/bluenimble-cli-1.4.0-bin.zip) or [bluenimble-cli-1.4.0-bin.tar.gz](https://github.com/bluenimble/serverless/releases/download/v1.4.0/bluenimble-cli-1.4.0-bin.tar.gz) and decompress in a folder of your choice
* If you're a Mac or Linux user, set the right .sh file mode:
    ````
    cd ~/blueNimble-cli-1.4.0 && chmod 755 *.sh
    ````
