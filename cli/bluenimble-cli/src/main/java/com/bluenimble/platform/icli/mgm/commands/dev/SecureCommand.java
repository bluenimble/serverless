...
import com.bluenimble.platform.icli.mgm.commands.dev.impls.SecureApiHandler;

public class SecureCommand extends PrefixedCommand {
	...
	public SecureCommand () {
		super ("secure", 	"secure your api");
		addHandler (Subject.Api, new SecureApiHandler ());
	}
	...
	public CommandResult execute (Tool tool, Map<String, CommandOption> options)
		...
		if (BlueNimble.Workspace == null) {
			throw new CommandExecutionException ("\n  please set a valid workspace folder. use command 'ws <your workspace folder>' or 'ws <your workspace folder>'");
		}
