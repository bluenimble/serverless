return {
	...
	/**
	 * The only required function that you should implement, if no mock data provided in your spec.json
	 * 
	 ...
	 * which is defined in your service specification file spec.json 
	 * 
	 * Arguments:
	...
	execute: function (api, consumer, request, response) {
		return { greeting: 'Welcome to ' + request.service.name + ' function' };
	}
