...
if (typeof Command === 'undefined') {
	throw 'missing command arguments. eg. doc api [ApiNs required] [DocTemplate] outDirectory. Example: doc api myapi html ~/Desktop';
}
...
if (tokens [0] != 'api') {
	throw 'wrong push target object. eg. doc api [ApiNs required] [DocTemplate] outDirectory. Example: doc api myapi html ~/Desktop';
}
