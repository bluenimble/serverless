...
public class HistofCommand extends HistoCommand {

	private static final long serialVersionUID = 8809252448144097989L;

	public HistofCommand () {
		super ("histof", I18nProvider.get (I18N_COMMANDS + "histof.desc"));
	}

	@Override
	public CommandResult execute (Tool tool, Map<String, CommandOption> options)
			throws CommandExecutionException {
		return doExecute (tool, tool.getHistory ().size ());
	}
